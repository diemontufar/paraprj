...
static int const GRIDROWS = 20; //1000 Number of row grids
static int const GRIDCOLUMNS = 20;//1500 Number of column grids

static int const CELLROWSPERGRID = 10; //30 Number of cell rows per grid
static int const CELLCOLUMNSPERGRID = 10; //30 Number of coll columns per grid
